package com.lightricity.station.tagsettings.ui
...
import com.lightricity.station.network.ui.ShareSensorActivity
import com.lightricity.station.tagsettings.di.TagSettingsViewModelArgs
import com.lightricity.station.tagsettings.domain.HumidityCalibrationInteractor
import com.lightricity.station.units.domain.UnitsConverter
import com.lightricity.station.util.CsvExporter
import com.lightricity.station.util.Utils
import com.lightricity.station.util.extensions.makeWebLinks
import com.lightricity.station.util.extensions.setDebouncedOnClickListener
        ...
        if (takePictureIntent.resolveActivity(packageManager) != null) {
            ...
            if (photoFile != null) {
                ...
                viewModel.file = FileProvider.getUriForFile(
                    this,
                    "com.lightricity.station.fileprovider",
                    photoFile
                )
