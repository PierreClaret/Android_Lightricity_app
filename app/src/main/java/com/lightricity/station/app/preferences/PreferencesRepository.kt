...
import com.lightricity.station.util.DeviceIdGenerator
...
class PreferencesRepository(private val preferences: Preferences) {
    ...
    fun getLightUnit(): LightUnit =
        preferences.lightUnit

    fun setLightUnit(unit: LightUnit) {
        preferences.lightUnit = unit
    }

    fun getSoundUnit(): SoundUnit =
        preferences.soundUnit

    fun setSoundUnit(unit: SoundUnit) {
